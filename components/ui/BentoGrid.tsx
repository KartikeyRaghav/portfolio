...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("kartikeyraghav2006@gmail.com");
    setCopied(true);
  };
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 2 && <GridGlobe />}
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2 lg:top-0">
              <div className="flex flex-col gap-3 lg:gap-4">
                {["React.js", "Next.js", "Vite.js"].map((item, i) => (
                  <span
                    key={i}
              ...
              <div className="flex flex-col gap-3 lg:gap-4">
                <span className="py-2.5 px-3 rounded-lg text-center bg-[#10132E]"></span>
